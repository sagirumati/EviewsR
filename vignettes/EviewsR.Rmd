...
plot(import$eviewsr_page,type="l",ylab="EviewsR",col="red")
ggplot2::autoplot(import$eviewsr_page,facet='')
```
...
```{r export}
export_dataframe(wf="eviewr_export",source_description=import$eviewsr_page,start_date = '1990',frequency = "m")
