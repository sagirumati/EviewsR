...
A chunk for Eviews can be created by supplying `eviews` as the engine name in R Markdown or Quarto document as shown below :
...
```{r}
#| label: fig-import
#| fig.cap: Plots of imported series
#| dpi: 300
