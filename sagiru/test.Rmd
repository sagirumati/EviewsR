...
```{eviews ev,eval=TRUE,out.extra = 'angle=45',out.width="0.2\\textwidth"}
...
```{r eviews12,out.width="0.2\\textwidth",out.extra = 'angle=90',fig.cap='rotated'}
