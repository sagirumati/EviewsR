...
library(EviewsR)
knitr::opts_chunk$set(echo = T,prompt = T,fig.align = "center",fig.pos="h",eval = T,fig.show = 'hold',out.width="0.2\\textwidth")

# set_eviews_path("eviews10")
```


```{eviews ev,eval=TRUE,out.width="0.2\\textwidth"}
...
```{r eviews12,out.width="0.2\\textwidth",fig.ncol=2}
