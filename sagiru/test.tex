...
\begin{Shaded}
\begin{Highlighting}[]
\SpecialCharTok{\textgreater{}}\NormalTok{ EviewsR3}\SpecialCharTok{$}\NormalTok{page1\_ols\_equation}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{test_files/figure-latex//import-EviewsR3-GRAPH1} \end{center}

\begin{center}\includegraphics{test_files/figure-latex//import-EviewsR3-GRAPH2} \end{center}

\begin{center}\includegraphics{test_files/figure-latex//import-EviewsR3-GRAPH3} \end{center}
