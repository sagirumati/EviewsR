...
{\centering \subfloat[Graph3 of EviewsR page\label{fig:ev-1}]{\includegraphics[width=0.3\linewidth]{test_files/figure-latex//evpage2-GRAPH1} }\subfloat[Graph2 of EviewsR page\label{fig:ev-2}]{\includegraphics[width=0.3\linewidth]{test_files/figure-latex//evpage2-GRAPH2} }\subfloat[Graph1 of EviewsR page\label{fig:ev-3}]{\includegraphics[width=0.3\linewidth]{test_files/figure-latex//evpage2-GRAPH3} }\newline\subfloat[Graph3 of Page1 page\label{fig:ev-4}]{\includegraphics[width=0.3\linewidth]{test_files/figure-latex//evEviewsR3-GRAPH1} }\subfloat[Graph2 of Page1 page\label{fig:ev-5}]{\includegraphics[width=0.3\linewidth]{test_files/figure-latex//evEviewsR3-GRAPH2} }\subfloat[Graph1 of Page1 page\label{fig:ev-6}]{\includegraphics[width=0.3\linewidth]{test_files/figure-latex//evEviewsR3-GRAPH3} }\newline\subfloat[Graph3 of EviewsR page\label{fig:ev-7}]{\includegraphics[width=0.3\linewidth]{test_files/figure-latex//evpage1-GRAPH1} }\subfloat[Graph2 of EviewsR page\label{fig:ev-8}]{\includegraphics[width=0.3\linewidth]{test_files/figure-latex//evpage1-GRAPH2} }\subfloat[Graph1 of EviewsR page\label{fig:ev-9}]{\includegraphics[width=0.3\linewidth]{test_files/figure-latex//evpage1-GRAPH3} }
