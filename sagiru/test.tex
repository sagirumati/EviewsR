...
\begin{figure}[h]
\subfloat[Graph3 of EviewsR page\label{fig:ev-1}]{\includegraphics[width=0.19\textwidth,height=0.25\textwidth,angle=45]{test_files/figure-latex//ev-page2-GRAPH3} }\subfloat[Graph2 of EviewsR page\label{fig:ev-2}]{\includegraphics[width=0.19\textwidth,height=0.25\textwidth,angle=45]{test_files/figure-latex//ev-page2-GRAPH2} }\subfloat[Graph1 of EviewsR page\label{fig:ev-3}]{\includegraphics[width=0.19\textwidth,height=0.25\textwidth,angle=45]{test_files/figure-latex//ev-page2-GRAPH1} }\subfloat[Graph3 of Page1 page\label{fig:ev-4}]{\includegraphics[width=0.19\textwidth,height=0.25\textwidth,angle=45]{test_files/figure-latex//ev-EviewsR3-GRAPH3} }\subfloat[Graph2 of Page1 page\label{fig:ev-5}]{\includegraphics[width=0.19\textwidth,height=0.25\textwidth,angle=45]{test_files/figure-latex//ev-EviewsR3-GRAPH2} }\newline\subfloat[Graph1 of Page1 page\label{fig:ev-6}]{\includegraphics[width=0.19\textwidth,height=0.25\textwidth,angle=45]{test_files/figure-latex//ev-EviewsR3-GRAPH1} }\caption{Figures automatically imported by eviews chunk (page="eviewsr page1", graph="asis")}\label{fig:ev}
\end{figure}
