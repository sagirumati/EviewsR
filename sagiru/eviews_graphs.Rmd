...
```{eviews biscuit,fig.cap= 'Figures automatically imported by eviews 2',fig.cur=9, fig.num=9,save_options="t=pdf"}
...
```{eviews saniya,fig.cap= 'Figures automatically imported by eviews', fig.cur=9, fig.num=9}
#| fig.cap: Figures automatically imported 2
#| fig.subcap: !expr paste(rep("Figure",9),1:3,"of",rep(c("EviewsR","Page1","Page2"),each=3),"page")
#| fig.show: hold
#| graph_procs: [template magazine,legend position(right)]
#| out.width: 0.3\textwidth
