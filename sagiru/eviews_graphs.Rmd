...
```{eviews biscuit,eval=F,fig.env="figure",fig.cap= 'Figures automatically imported by eviews chunk (page=T, fig.keep="high")',fig.cur=9, fig.num=9}
...
```{eviews saniya,eval=F,fig.env="figure",fig.cap= 'Figures automatically imported by eviews chunk (page=T, fig.keep="new")', fig.cur=9, fig.num=9}
