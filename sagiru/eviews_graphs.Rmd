...
```{eviews biscuit,fig.cap= 'Figures automatically imported by eviews chunk (page=T, fig.keep="high")',fig.cur=9, fig.num=9,save_options="t=pdf"}
...
```{eviews saniya,fig.cap= 'Figures automatically imported by eviews chunk (page=T, fig.keep="new")', fig.cur=9, fig.num=9}
