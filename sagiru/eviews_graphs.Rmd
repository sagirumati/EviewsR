...
library(EviewsR)
knitr::opts_chunk$set(echo = T,prompt = T,fig.pos="h",eval = T)
...
```{r graphp,fig.cap="Nice graph",out.width="\\textwidth",fig.show='hold'}
x=cumsum(rnorm(100))
y=cumsum(rnorm(100))
z=cumsum(rnorm(100))
data=data.frame(x,y,z)
eviews_graph(data,group = T,options = 'm')
