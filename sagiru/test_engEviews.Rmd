...
library(EviewsR)
knitr::opts_chunk$set(echo = T,prompt = T,fig.align = "center",fig.pos="h",out.width = "0.45\\textwidth",eval = T)
...
```{eviews mychunk,page="mati page2 page1 page3" ,prompt=T,fig.cap="somefigure",fig.subcap=paste("Page",rep(1:4,each=4),"Figure",1:4)}
#| fig.show: hold
#| graph_procs: 
...
```{eviews sagirumati,page=T,fig.show="hold",fig.cap="Dynamic figure",fig.keep='new',graph_procs="template midnight"}
...
```{eviews biscuit,eval=T,fig.env="figure",fig.cap= 'Figures automatically imported by eviews chunk (page=T, fig.keep="high")'}
...
```{eviews saniya,eval=T,fig.env="figure",fig.cap= 'Figures automatically imported by eviews chunk (page=T, fig.keep="new")'}
#| #fig.cap: Figures automatically imported by eviews chunk (page=T, fig.keep="new")
#| fig.subcap: !expr paste(rep("Figure",9),1:3,"of",rep(c("EviewsR","Page1","Page2"),each=3),"page")
#| fig.show: hold
#| graph_procs: [template magazine,legend position(right)]
#| out.width: 0.3\textwidth
