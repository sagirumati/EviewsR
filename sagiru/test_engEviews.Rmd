...
```{eviews mychunk,page=F,prompt=T,eval=T,fig.cap="somefigure",fig.subcap=paste("Page",rep(1:4,each=4),"Figure",1:4)}
#| fig.show: hold
#| echo: TRUE
#| graph_procs: 
...
```{eviews sagirumati,eval=T,page=T,fig.show="hold",fig.cap="Dynamic figure",fig.keep="all"}
