...
```{eviews biscuit,eval=F,fig.env="figure",fig.cap= 'Figures automatically imported by eviews chunk (page=T, fig.keep="high")'}
...
```{eviews saniya,eval=F,fig.env="figure",fig.cap= 'Figures automatically imported by eviews chunk (page=T, fig.keep="new")'}
