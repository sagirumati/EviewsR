...
library(EviewsR)
knitr::opts_chunk$set(echo = F,prompt = T,fig.align = "center",fig.pos="h",out.width = "\\textwidth")
...
```{eviews mychunk,page=F,prompt=T,eval=TRUE,fig.cap="somefigure",fig.subcap=c("A figure","Another figure")}
#| fig.show: hold
#| echo: TRUE
#| fig.keep: new
#| graph_procs: 
...
eviews_graph(eviews$xyz,group = T,graph_procs = "template(b) midnight",graph_command = "scat")
```
