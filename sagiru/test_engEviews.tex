...
{\centering \subfloat[Page 1 Figure 1\label{fig:mychunk-1}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-mati-grap} }\subfloat[Page 1 Figure 2\label{fig:mychunk-2}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-mati-grap1} }\subfloat[Page 1 Figure 3\label{fig:mychunk-3}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-mati-grap2} }\subfloat[Page 1 Figure 4\label{fig:mychunk-4}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-mati-grap3} }\newline\subfloat[Page 2 Figure 1\label{fig:mychunk-5}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page1-grap} }\subfloat[Page 2 Figure 2\label{fig:mychunk-6}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page1-grap1} }\subfloat[Page 2 Figure 3\label{fig:mychunk-7}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page1-grap2} }\subfloat[Page 2 Figure 4\label{fig:mychunk-8}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page1-grap3} }\newline\subfloat[Page 3 Figure 1\label{fig:mychunk-9}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page2-grap} }\subfloat[Page 3 Figure 2\label{fig:mychunk-10}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page2-grap1} }\subfloat[Page 3 Figure 3\label{fig:mychunk-11}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page2-grap2} }\subfloat[Page 3 Figure 4\label{fig:mychunk-12}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page2-grap3} }\newline\subfloat[Page 4 Figure 1\label{fig:mychunk-13}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page3-grap} }\subfloat[Page 4 Figure 2\label{fig:mychunk-14}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page3-grap1} }\subfloat[Page 4 Figure 3\label{fig:mychunk-15}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page3-grap2} }\subfloat[Page 4 Figure 4\label{fig:mychunk-16}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page3-grap3} }
...
\begin{verbatim}
##         date        x           y          z
## 1 2020-01-01 0.388395 -0.17936981  0.5196050
## 2 2021-01-01 1.269529 -0.92538641 -0.1989131
## 3 2022-01-01 1.664056 -0.17505452  0.9760468
## 4 2023-01-01 2.354103  0.47145092  0.2707267
## 5 2024-01-01 1.214636 -0.04784482 -3.0298741
## 6 2025-01-01 1.389793 -0.39139365 -3.5968215
\end{verbatim}
...
\begin{verbatim}
##         date            x          y           z
## 1 2000-01-01 -2.626039333 -0.2793415 -1.17747346
## 2 2000-04-01 -3.138716861 -1.0872624 -0.05735493
## 3 2000-07-01 -2.537947493 -1.2989090  1.66010502
## 4 2000-10-01 -1.627608154 -0.1380400  1.31324647
## 5 2001-01-01 -0.523627770 -1.4249132  0.98635311
## 6 2001-04-01  0.006720343 -2.2500313  1.20304483
\end{verbatim}
