...
{\centering \subfloat[Page 1 Figure 1\label{fig:mychunk-1}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-mati-grap} }\subfloat[Page 1 Figure 2\label{fig:mychunk-2}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page1-grap} }\subfloat[Page 1 Figure 3\label{fig:mychunk-3}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page2-grap} }\subfloat[Page 1 Figure 4\label{fig:mychunk-4}]{\includegraphics[width=0.25\textwidth]{test_engEviews_files/figure-latex//mychunk-page3-grap} }
