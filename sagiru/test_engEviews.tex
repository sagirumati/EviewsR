...
{\centering \subfloat[A figure\label{fig:mychunk-1}]{\includegraphics[width=0.45\textwidth]{test_engEviews_files/figure-latex//mychunk-grap1} }\subfloat[Another figure\label{fig:mychunk-2}]{\includegraphics[width=0.45\textwidth]{test_engEviews_files/figure-latex//mychunk-grap2} }\newline\subfloat[A figure\label{fig:mychunk-3}]{\includegraphics[width=0.45\textwidth]{test_engEviews_files/figure-latex//mychunk-grap} }
