...
* I wish I could dynamically import EViews outputs (graphs, tables, equation and series) into R, R Markdown or Quarto document without switching between these applications back and forth.

* I wish I could graph EViews series objects in R, R Markdown or Quarto.

* I wish I could graph an R dataframe using EViews in R, R Markdown or Quarto without opening EViews!


* I wish I could use an R function in R, R Markdown or Quarto to import data as a new EViews workfile or into an existing workfile.


* I wish I could use R function to create a workfile

* I wish I could use R function to save an EViews workfile page as a workfile or another file format.

* I wish I could use an R function in R, R Markdown or Quarto to execute EViews codes.

* I wish I could use R function to export an R dataframe a new EViews workfile or to an existing EViews workfile.




* I wish I could use R function to save an EViews workfile as a workfile or another file format.


* I wish I could simulate a random walk process using EViews in R, R Markdown or Quarto.
