...
<img src="README_files/figure-markdown_strict//EviewsREviewsRPage-XX.png" alt="EViews graphs imported automatically by fig-EviewsR chunk" width="45%" height="20%" /><img src="README_files/figure-markdown_strict//EviewsREviewsRPage-YY.png" alt="EViews graphs imported automatically by fig-EviewsR chunk" width="45%" height="20%" />
<p class="caption">
...
<table>
<caption>Selected cells of EViews table object</caption>
<tbody>
<tr class="odd">
...
<img src="README_files/figure-markdown_strict//eviewsGraph-EviewsRPage-X.png" alt="Graphs of existing EViews series objects imported by fig-eviewsGraph chunk" width="45%" height="30%" /><img src="README_files/figure-markdown_strict//eviewsGraph-EviewsRPage-Y.png" alt="Graphs of existing EViews series objects imported by fig-eviewsGraph chunk" width="45%" height="30%" />
<p class="caption">
Graphs of existing EViews series objects imported by fig-eviewsGraph
chunk
</p>
...
<img src="README_files/figure-markdown_strict//eviewsGraph1-Eviewsgraph1-XY.png" alt="Graphs of an R dataframe imported by fig-eviewsGraph1 chunk" width="90%" height="70%" />
<p class="caption">
Graphs of an R dataframe imported by fig-eviewsGraph1 chunk
</p>

### The eviews\_import() function
...
### The import\_graph() function

Import EViews graph objects(s) into R, R Markdown or Quarto.

    import_graph(wf = "eviewsr_workfile")

<img src="README_files/figure-markdown_strict//fig-importGraph-EviewsRPage-XX.png" alt="EViews graphs imported using import\_graph() function" width="45%" height="20%" /><img src="README_files/figure-markdown_strict//fig-importGraph-EviewsRPage-YY.png" alt="EViews graphs imported using import\_graph() function" width="45%" height="20%" />
<p class="caption">
EViews graphs imported using import\_graph() function
</p>
...
<img src="README_files/figure-markdown_strict//fig-importGraph1-eviewsPage-X_GRAPH.png" alt="EViews graphs that begin with X imported using import\_graph() function" width="45%" height="20%" /><img src="README_files/figure-markdown_strict//fig-importGraph1-eviewspage1-X_GRAPH.png" alt="EViews graphs that begin with X imported using import\_graph() function" width="45%" height="20%" />
<p class="caption">
EViews graphs that begin with X imported using import\_graph() function
</p>

### The import\_kable() function
...
<table>
<caption>
Selected cells of EViews table imported using import\_kable() function
</caption>
<thead>
<tr>
...
<img src="README_files/figure-markdown_strict//fig-importWorkfile-EviewsRPage-XX.png" alt="EViews graphs automatically imported by import\_workfile() function" width="45%" height="20%" /><img src="README_files/figure-markdown_strict//fig-importWorkfile-EviewsRPage-YY.png" alt="EViews graphs automatically imported by import\_workfile() function" width="45%" height="20%" />
<p class="caption">
EViews graphs automatically imported by import\_workfile() function
</p>
...
<img src="README_files/figure-markdown_strict/fig-rwalk-1.png" alt="Plots of imported EViews random walk series objects" width="45%" height="20%" /><img src="README_files/figure-markdown_strict/fig-rwalk-2.png" alt="Plots of imported EViews random walk series objects" width="45%" height="20%" />
<p class="caption">
Plots of imported EViews random walk series objects
</p>
